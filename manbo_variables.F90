...
MODULE manbo_variables
  ...
  ! atom_out contains the information about a replicated atom outside the box
    ...
    ! mol is the molecule in which a given atom outside the box
  ...
  TYPE(mass_center), DIMENSION(:), ALLOCATABLE, SAVE :: mc, mc_out
  ...
  INTEGER :: n_atoms, n_mols, n_mols_orig, n_atoms_out, n_mols_out, n_qm_procs, qm_prog_memory
  ...
  ! n_mols_out is the number of molecules which are outside of the box
